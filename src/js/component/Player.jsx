...
const Player = (props) => {
  ...
  return (
    <div className='w-50 bg-dark d-flex gap-5 justify-content-center align-item-center py-2'>
      ...
      <button className='rounded bg-white' onClick={handlePlayPause} disabled={!selectedSong}>{isPlaying?<i className="fa-solid fa-pause fs-4"></i>:<i className="fa-solid fa-play"></i>}</button>
